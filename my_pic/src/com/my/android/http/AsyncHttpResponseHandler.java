...
public class AsyncHttpResponseHandler {
    ...
    public void onKeySuccess(String content) {}
    ...
    public void onSuccess(int statusCode, String content)
    {
        ...
        if(!Tools.isNull(content)&&!content.contains("{")){
        	onKeySuccess(content); 
           SystemOut.out("encryption");
           content = MathUtils.desEncryptAsString(content, MathUtils.COMMON_KEY);
          SystemOut.out("result desEncrypt:"+content);
           onSuccess(content);
        }else{
          SystemOut.out("no desEncrypt");
          onSuccess(content);
        }
    }
